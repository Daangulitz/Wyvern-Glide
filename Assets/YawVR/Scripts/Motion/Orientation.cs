...
{
    /// <summary>
    /// Computes pitch/yaw/roll from this transform's rotation. Moved into the YawVR
    /// namespace as part of the SOLID refactor (it previously lived in the global
    /// namespace, which was almost certainly an oversight rather than intentional) —
    /// safe because this class has no serialized fields for Unity to lose track of.
    /// </summary>
