...
namespace YawVR.Legacy
{
    // ARCHIVED — frozen as of the SOLID refactor (see /YawVR/Legacy/README.md).
    // Superseded by YawVR.TcpReliableConnection (Scripts/Transport/), which implements
    // IReliableConnection with the same wire behavior plus three bug fixes. Nothing in
    // the active SDK references this file; it is kept only as a rollback/diff reference.
