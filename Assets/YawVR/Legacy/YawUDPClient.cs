...
namespace YawVR.Legacy
{
    ...
    // Superseded by YawVR.UdpDatagramChannel (Scripts/Transport/), which implements
    // IDatagramChannel with the same wire behavior. Nothing in the active SDK
    // references this file; it is kept only as a rollback/diff reference.
